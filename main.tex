...
\Huge \color{DarkRed} \textbf{My first EMC poster} \color{Black}\\ % Title
\huge\textit{With a subtitle here}\\[1cm] % Subtitle
\large \textbf{John Smith \& Jane Smith}\\[0.5cm] % Author(s)
\large Exeter Mathematics School\\[0.2cm] % University/organization
\texttt{Traditional to put email address here}\\
\end{minipage}
%
\begin{minipage}[b]{0.4\linewidth}
\includegraphics[height=5cm]{logo_semat.pdf}
\includegraphics[height=5cm,trim=5cm 5cm 0cm 5cm,clip]{logo_goiania.png}
\end{minipage}
